...
<div class="main">
	...
	<form class="form" method="post">
		...
		<input type='hidden' name='bno' value="${boardDTO.titleNum}">
		<input type='hidden' name='page' value="${pageMaker.page}"> <input
		...
		<h2>
			<input type="text" name='title' style="width: 100%"
				value="${boardDTO.faqtitle}">
		</h2>

		<h2>
			Content
			<textarea style="width: 100%" name="content" rows="3">${boardDTO.faqcontent}</textarea>
		</h2>

		<h2>
			Writer <input type="text" name="writer" style="width: 100%"
				value="${boardDTO.faqwriter}">
			</h2>
	</form>
	<!-- /.box-body -->
