	...
	function getPageList(page){
		$.getJSON("/ex/replies/"+bno+"/"+page,function(data){
			...
			$(data.list).each(function(){
				...
				+this.rno+" "+this.replyer+":"+this.replytext+" <button>Mod</button></li>"
			})
			$("#replies").html(str);
...
<div class="main">
	...
	<form class="form" method="post">
		...
		<input type='hidden' name='bno' value="${boardDTO.titleNUm}"> <input
	...
	<h2>
		<input type="text" name='title' style="width: 100%"
			value="${boardDTO.faqtitle}" readonly="readonly">
	</h2>

	<h2>
		Content
		<textarea style="width: 100%" name="content" rows="3"
			readonly="readonly">${boardDTO.faqcontent}</textarea>
	</h2>

	<h2>
		Writer <input type="text" name="writer" style="width: 100%"
			value="${boardDTO.userID}" readonly="readonly">
		</h2>
