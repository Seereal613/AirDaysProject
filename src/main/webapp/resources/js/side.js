$(function(){
	...
	*/
	...
	//헤더 - 최근본 상품
	$("#layout_header .ico_floating_recently").click(function(){
		$("#recently_top_popup").fadeIn();
		$("#recently_top_popup").find(".recently_bg").fadeIn();
		$("html").attr("class","overflow").bind('touchmove', function(e){e.preventDefault()});
	});
	$("#layout_header .recently_popup .btn_close").click(function(){
		$("#recently_top_popup").fadeOut();
		$("#recently_top_popup").find(".recently_bg").fadeOut();
		$("html").attr("class","auto").unbind('touchmove');
	});
